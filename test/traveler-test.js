...
describe("Traveler", () => {
  ...
  it("Should return message if user doesn't exist", () => {
    const traveler2 = new Traveler(travelerData[10]);
    const errorMessage = traveler2.getFirstName();
    expect(errorMessage).to.equal("Can't find that user");
  });
});
